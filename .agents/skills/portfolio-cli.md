---
name: portfolio-cli
description: Apoia a criação e evolução de portfólio profissional no GitHub para engenheiros de software Pleno/Sênior, com análise de carreira, projetos personalizados e evidências de engenharia. Entrada CLI para portfolio-architect. Usar para planejar, construir ou revisar esse portfólio.
---
